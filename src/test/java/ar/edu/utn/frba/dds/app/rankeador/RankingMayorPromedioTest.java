...
public class RankingMayorPromedioTest {
    ...
    @Test
    public void rankingEntidadTiempoPromedio() {
        ...
        CriterioRanking rankingMayorPromedio = new RankingMayorPromedio();

        ranking.agregarCriterio(rankingMayorPromedio);
        LocalDateTime currentDateTime = LocalDateTime.now();
        LocalDateTime en1dias = currentDateTime.plusDays(1);
        LocalDateTime en3dias = currentDateTime.plusDays(3);
        LocalDateTime en10dias = currentDateTime.plusDays(10);
        ...
        incidente6.cerrar(en1dias, bart);
        incidente7.cerrar(en1dias, bart);
        incidente8.cerrar(en3dias, bart);
        incidente9.cerrar(en3dias, bart);
        incidente10.cerrar(en3dias, bart);
        incidente1.cerrar(en10dias, bart);
        incidente2.cerrar(en10dias, bart);
        incidente3.cerrar(en10dias, bart);
        incidente4.cerrar(en10dias, bart);
        incidente4.cerrar(en10dias, bart);
        incidente5.cerrar(en10dias, bart);
